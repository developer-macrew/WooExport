...
if( !class_exists( 'wpg_order_export' ) ){
	...
	static function get_settings_fields() {
			...
			$settings = array(
				...
				'customer_name' => array(
					'name' => __( 'First Name', 'woocommerce-simply-order-export' ),
					'type' => 'checkbox',
					'desc' => __( 'First Name', 'woocommerce-simply-order-export' ),
					'id'   => 'wc_settings_tab_customer_name'
				),
				'customer_last_name' =>array(
				  'name' =>__('Customer Last Name','woocommerce-simply-order-export'),
				  'type'=>'checkbox',
				  'desc'=>__('Customer Last Name','woocommerce-simply-order-export'),
				  'id' => 'wc_settings_tab_customer_last_name'
				),
				...
				'company' =>array(
					'name'=> __('Company Name','woocommerce-simply-order-export'),
					'type' => 'checkbox',
					'desc' => __('Company Information','woocommerce-simply-order-export'),
					'id'   => 'wc_settings_tab_customer_company'
				),
				'street_address' =>array(
				  'name' =>__('Street Address','woocommerce-simply-order-export'),
				  'type' => 'checkbox',
				  'desc' =>  __('Street 1 address','woocommerce-simply-order-export'),
				  'id'   => 'wc_settings_tab_customer_street_address1'
				),
				'street_address2' =>array(
				'name' =>__('Street Address 2','woocommerce-simply-order-export'),
				'type'=>'checkbox',
				'desc' => __('Street2 Address','woocommerce-simply-order-export'),
				'id'   => 'wc_settings_tab_customer_street_address2'
				),
			   'city' => array(
			    'name' => __('City Information','woocommerce-simply-order-export'),
				'type'=> 'checkbox',
				'desc' => __('Customer city Address','woocommerce-simply-order-export'),
				'id'   => 'wc_settings_tab_customer_city'
			   ),
			   'state' =>array(
			   'name' =>__('State','woocommerce-simply-order-export'),
			   'type'=> 'checkbox',
			   'desc'=> __('Customer State Information','woocommerce-simply-order-export'),
			    'id'   => 'wc_settings_tab_customer_state'
			   ),
			   'zipcode' => array(
			   'name' =>__('Zipcode','woocommerce-simply-order-export'),
			   'type' =>'checkbox',
			   'desc'=>__('Customer Zipcode Information','woocommerce-simply-order-export'),
			    'id'   => 'wc_settings_tab_customer_zip_code'
			   ),
			  'country' =>array(
			  'name' =>__('country name','woocommerce-simply-order-export'),
			  'type' =>'checkbox',
			  'desc' =>__('Customer Country Information','woocommerce-simply-order-export'),
			  'id'   => 'wc_settings_tab_customer_country'
			  ),
			  'item_number' =>array(
			  'name' =>__('SKU','woocommerce-simply-order-export'),
			  'type'=>'checkbox',
			  'desc' =>__('Product Item Number','woocommerce-simply-order-export'),
			  'id'   => 'wc_settings_tab_customer_item_number'
			  ),
			 'order_date' =>array(
			  'name' =>__('Order Date','woocommerce-simply-order-export'),
			  'type'=>'checkbox',
			  'desc' =>__('Product Order date or payment date','woocommerce-simply-order-export'),
			  'id'   => 'wc_settings_tab_customer_order_date'
			  ),

			  'order_notes' =>array(
			  'name'=>__('Custom Message','woocommerce-simply-order-export'),
			  'type'=>'checkbox',
			  'desc'=>__('Custom Order Message or Order Notes','woocommerce-simply-order-export'),
			  'id'   => 'wc_settings_tab_customer_order_notes'
			  )
		...
		function section_end() { ?>
			...
			<div class="clearfix wpg-inputs">
				...
				<div class="orderexport-button">
					<input type="button" class="button wpg-order-export" rel="" value="<?php _e('Export Orders', 'woocommerce-simply-order-export') ?>" />
					<input type="button" class="button wpg-order-export" rel="refer_candy" value="<?php _e('Export Orders Referal Candy', 'woocommerce-simply-order-export') ?>" />
