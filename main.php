<?php
/**
 * Plugin Name: Macrew Order Export
 * Description: Export Orders Details in CSV format 
	...
	class WooCommerce_simply_order_export {
		 ...
		 */
			...
			$this->wpg_order_columns = apply_filters( 'wpg_order_columns', array(
												...
												'wc_settings_tab_customer_name'=>__( 'First Name', 'woocommerce-simply-order-export' ),
												'wc_settings_tab_customer_last_name'=>__( 'Last Name', 'woocommerce-simply-order-export' ),
												...
												'wc_settings_tab_customer_company'=>__('company Name', 'woocommerce-simply-order-export'),
												'wc_settings_tab_customer_street_address1'=>__('Street Address1', 'woocommerce-simply-order-export'),
												'wc_settings_tab_customer_street_address2'=>__('Street Address2', 'woocommerce-simply-order-export'),
												'wc_settings_tab_customer_city'=>__('City', 'woocommerce-simply-order-export'),
												'wc_settings_tab_customer_state'=>__('State', 'woocommerce-simply-order-export'),
												'wc_settings_tab_customer_zip_code'=>__('Zip Code', 'woocommerce-simply-order-export'),
												'wc_settings_tab_customer_country'=>__('Country', 'woocommerce-simply-order-export'),
												'wc_settings_tab_customer_item_number'=>__('Item No.', 'woocommerce-simply-order-export'),
												'wc_settings_tab_customer_order_date'=>__('Order Date', 'woocommerce-simply-order-export'),
												'wc_settings_tab_customer_order_notes'=>__('Custom Message', 'woocommerce-simply-order-export'),
